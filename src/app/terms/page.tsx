        ...
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <LegalBulletList
              ...
              items={
                [
                  { id: "use-the-service-for-any-unlawful-purpose", content: <>Use the service for any unlawful purpose</> },
                  { id: "attempt-to-gain-unauthorized-access-to-any-part", content: <>Attempt to gain unauthorized access to any part of the service</> },
                  { id: "interfere-with-or-disrupt-the-service-or-its-ser", content: <>Interfere with or disrupt the service or its servers</> },
                  { id: "use-automated-systems-to-access-the-service-with", content: <>Use automated systems to access the service without permission</> }
                ]
              }
            />
          </section>
